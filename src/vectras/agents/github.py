...
1. Create a new branch with a descriptive name (e.g., "fix-divide-tool-bug-YYYYMMDD-HHMMSS")
2. Commit the relevant files to the branch (use the correct file paths like "test_tools/divide.py")
3. Create a pull request with a descriptive title and body

For divide tool fixes, use these specific files:
- test_tools/divide.py (the main tool file)
- README.md (if it exists)

Always take action rather than just explaining the process. Use the create_complete_pr_workflow tool when possible.
