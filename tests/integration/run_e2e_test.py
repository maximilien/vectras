#!/usr/bin/env python3
"""
End-to-End Test Runner for Vectras Agent Flow

This script starts all the required agents and runs the comprehensive end-to-end test
that verifies the complete flow of all agents working together.
"""
